...
HTML version of this org file (which is rendered better than what you currently see on GitHub) is made with [[https://github.com/fniessen/org-html-themes][org-html-themes]] and is available [[https://naghdbishi.ir/Doom-Emacs-Cheat-Sheet/README.html][here]].
You can also [[https://raw.githubusercontent.com/niyumard/Doom-Emacs-Cheat-Sheet/main/README.org][download this file]] and open it in Emacs.
